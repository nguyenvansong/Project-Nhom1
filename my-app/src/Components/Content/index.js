...
function Content(){
    ...
    // Tính toán chỉ số của item đầu tiên và cuối cùng trên trang hiện tại
    ...
    // Lấy một phần của dữ liệu hiện tại cho trang hiện tại
                                        ...
                                        <WrapProduct>
                                            <div className={clsx(styles.product)} onClick={() => {
                                                ...
                                                <div className={clsx(styles.info_product)}>
                                                    ...
                                                    <span className={clsx(styles.span_price)}>{product.price}<span className="span-vnd">đ</span></span>
                                                </div>
                                            </div>
                                        </WrapProduct>
                                    )
                    ...
                    <div>
                        <ul className="pagination pagination_list">
                            ...
                            {pageNumbers2.map((number) => (
                                <li key={number} className="page-item">
                                <button onClick={() => setCurrentPage2(number)} className="page-link">
                                    {number}
                                </button>
                                </li>
                            ))}
                    ...
                    <div>
                        <ul className="pagination pagination_list">
                            ...
                            {pageNumbers3.map((number) => (
                                <li key={number} className="page-item">
                                <button onClick={() => setCurrentPage3(number)} className="page-link">
                                    {number}
                                </button>
                                </li>
                            ))}
